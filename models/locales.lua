...
function LocalesModel:Create()
    return {
        ...
        ["en"] = {
            ...
            ["ProfessionsViewCategory"] = "Category",
            ["ProfessionsViewCategoryAll"] = "All Categories",
            ["ProfessionsViewSubcategory"] = "Subcategory",
            ["ProfessionsViewSubcategoryAll"] = "All Subcategories",
            ["ProfessionsViewSearch"] = "Search",
            ["ProfessionsViewItem"] = "Item",
            ["ProfessionsViewDifficulty"] = "Difficulty",
        ...
        ["de"] = {
            ...
            ["ProfessionsViewCategory"] = "Kategorie",
            ["ProfessionsViewCategoryAll"] = "Alle Kategorien",
            ["ProfessionsViewSubcategory"] = "Unterkategorie",
            ["ProfessionsViewSubcategoryAll"] = "Alle Unterkategorien",
            ["ProfessionsViewSearch"] = "Suchen",
            ["ProfessionsViewItem"] = "Gegenstand",
            ["ProfessionsViewDifficulty"] = "Schwierigkeit",
        ...
        ["ru"] = {
            ...
            ["ProfessionsViewCategory"] = "Категория",
            ["ProfessionsViewCategoryAll"] = "Все категории",
            ["ProfessionsViewSubcategory"] = "Подкатегория",
            ["ProfessionsViewSubcategoryAll"] = "Все подкатегории",
            ["ProfessionsViewSearch"] = "Поиск",
            ["ProfessionsViewItem"] = "Предмет",
            ["ProfessionsViewDifficulty"] = "Сложность",
        ...
        ["es"] = {
            ...
            ["ProfessionsViewCategory"] = "Categoría",
            ["ProfessionsViewCategoryAll"] = "Todas las categorías",
            ["ProfessionsViewSubcategory"] = "Subcategoría",
            ["ProfessionsViewSubcategoryAll"] = "Todas las subcategorías",
            ["ProfessionsViewSearch"] = "Buscar",
            ["ProfessionsViewItem"] = "Objeto",
            ["ProfessionsViewDifficulty"] = "Dificultad",
        ...
        ["fr"] = {
            ...
            ["ProfessionsViewCategory"] = "Catégorie",
            ["ProfessionsViewCategoryAll"] = "Toutes les catégories",
            ["ProfessionsViewSubcategory"] = "Sous-catégorie",
            ["ProfessionsViewSubcategoryAll"] = "Toutes les sous-catégories",
            ["ProfessionsViewSearch"] = "Rechercher",
            ["ProfessionsViewItem"] = "Objet",
            ["ProfessionsViewDifficulty"] = "Difficulté",
        ...
        ["it"] = {
            ...
            ["ProfessionsViewCategory"] = "Categoria",
            ["ProfessionsViewCategoryAll"] = "Tutte le categorie",
            ["ProfessionsViewSubcategory"] = "Sottocategoria",
            ["ProfessionsViewSubcategoryAll"] = "Tutte le sottocategorie",
        ...
        ["ko"] = {
            ...
            ["ProfessionsViewCategory"] = "카테고리",
            ["ProfessionsViewCategoryAll"] = "모든 카테고리",
            ["ProfessionsViewSubcategory"] = "하위 카테고리",
            ["ProfessionsViewSubcategoryAll"] = "모든 하위 카테고리",
        ...
        ["pt"] = {
            ...
            ["ProfessionsViewCategory"] = "Categoria",
            ["ProfessionsViewCategoryAll"] = "Todas as categorias",
            ["ProfessionsViewSubcategory"] = "Subcategoria",
            ["ProfessionsViewSubcategoryAll"] = "Todas as subcategorias",
        ...
        ["zhCN"] = {
            ...
            ["ProfessionsViewCategory"] = "分类",
            ["ProfessionsViewCategoryAll"] = "所有分类",
            ["ProfessionsViewSubcategory"] = "子分类",
            ["ProfessionsViewSubcategoryAll"] = "所有子分类",
        ...
        ["zhTW"] = {
            ...
            ["ProfessionsViewAddon"] = "插件",
            ["ProfessionsViewAllAddons"] = "所有插件",
            ["ProfessionsViewCategory"] = "分類",
            ["ProfessionsViewCategoryAll"] = "所有分類",
            ["ProfessionsViewSubcategory"] = "子分類",
            ["ProfessionsViewSubcategoryAll"] = "所有子分類",
